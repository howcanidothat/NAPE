...
def get_default_config():
    ...
    cfg.model.kpr.kp_quality_threshold = 0.20
    cfg.model.kpr.visibility_binary_threshold = 0.5  # threshold for binarizing visibility scores at test time
    cfg.model.kpr.empty_visibility_fallback = True  # if a sample has no visible parts (all-zero visibility), use an all-visible mask as fallback at test time
