...
def build_transforms(
    ...
    **kwargs
    ...
    if config.model.nape.keypoints.enabled:
        ...
        kp_target_transform = [masks_preprocess_all[config.model.nape.keypoints.target_preprocess]()]
        kp_prompt_transform = [masks_preprocess_all[config.model.nape.keypoints.prompt_preprocess]()]
    ...
    if config.model.nape.masks.enabled:
