...
def load_checkpoint(fpath):
    ...
    try:
        ...
        # Handle various loading errors including weights_only issues
        error_str = str(e)
        if ("weights_only" in error_str or 
            "yacs.config.CfgNode" in error_str or 
            "UnpicklingError" in error_str or
            "numpy._core.multiarray.scalar" in error_str):
            print('Weights only load failed. Loading with weights_only=False for compatibility...')
            try:
